...
const EditProductPage = () => {
  ...
  useEffect(() => {
    if (product) {
      ...
      console.log("Set fulfillmentOptions to:", product.fulfillmentOptions || { delivery: false, pickup: false }); // Debug log
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        // Debug: Log the formData to see what we're sending
